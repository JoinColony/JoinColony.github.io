...
export const PAGE_DEVELOPER_PORTAL = '/developers';
...
export const PAGE_TUTORIALS = '/tutorials';
...
export const COLONY_GITHUB_TUTORIALS =
  'https://github.com/JoinColony/colonyTutorials';
