...
const MSG = defineMessages({
  answer1: {
    id: 'pages.Contribute.Landing.FAQ.answer1',
  ...
  answer2: {
    id: 'pages.Contribute.Landing.FAQ.answer2',
  ...
  answer3: {
    id: 'pages.Contribute.Landing.FAQ.answer3',
  ...
  answer4: {
    id: 'pages.Contribute.Landing.FAQ.answer4',
  ...
  answer5: {
    id: 'pages.Contribute.Landing.FAQ.answer5',
  ...
  answer6: {
    id: 'pages.Contribute.Landing.FAQ.answer6',
  ...
  answer7: {
    id: 'pages.Contribute.Landing.FAQ.answer7',
  ...
  answer8: {
    id: 'pages.Contribute.Landing.FAQ.answer8',
  ...
  question1: {
    id: 'pages.Contribute.Landing.FAQ.question1',
    defaultMessage: 'What is the CDEV Token?',
  },
  question2: {
    id: 'pages.Contribute.Landing.FAQ.question2',
    defaultMessage: 'What can I do with CDEV?',
  },
  question3: {
    id: 'pages.Contribute.Landing.FAQ.question3',
    defaultMessage: 'Can I transfer CDEV to another wallet or user?',
  },
  question4: {
    id: 'pages.Contribute.Landing.FAQ.question4',
    defaultMessage: 'What is reputation?',
  },
  question5: {
    id: 'pages.Contribute.Landing.FAQ.question5',
    defaultMessage: 'How is reputation calculated?',
  },
  question6: {
    id: 'pages.Contribute.Landing.FAQ.question6',
    defaultMessage: 'What can I do with reputation?',
  },
  question7: {
    id: 'pages.Contribute.Landing.FAQ.question7',
